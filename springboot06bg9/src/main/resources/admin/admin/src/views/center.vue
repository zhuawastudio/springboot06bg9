  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="学院" prop="xueyuan">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="手机" prop="shouji">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="学院" prop="xueyuan">
          <el-input v-model="ruleForm.xueyuan"               placeholder="学院" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="电话" prop="dianhua">
