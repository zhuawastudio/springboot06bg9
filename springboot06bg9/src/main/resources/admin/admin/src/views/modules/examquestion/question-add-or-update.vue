<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="选择试卷" prop="paperid">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="类型" prop="type">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="ruleForm.type!=3&&ruleForm.type!=2" label="选项" prop="options">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="ruleForm.type==0 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="ruleForm.type==1 && options.length>0" label="答案" prop="answer">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="ruleForm.type==2 && options.length>0" label="答案" prop="answer">
        <el-select v-model="ruleForm.answer">
          <el-option
            :label="item.text"
            :value="item.code"
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="ruleForm.type==3" label="答案" prop="answer">
        <el-input v-model="ruleForm.answer" placeholder="答案" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="分数" prop="score">
        <el-input-number v-model="ruleForm.score" :min="1" :max="100" label="分数"></el-input-number>
      </el-form-item>
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="分析" prop="analysis">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' label="排序" prop="sequence">
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        ...
        <el-button :style='{"border":"1px solid #999","cursor":"pointer","padding":"0 30px","boxShadow":"0 2px 6px rgba(100, 100,100, .2)","margin":"0","color":"#333","outline":"none","borderRadius":"20%","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(218,226,240,1) 100%)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">取消</el-button>
      </el-form-item>
    </el-form>
