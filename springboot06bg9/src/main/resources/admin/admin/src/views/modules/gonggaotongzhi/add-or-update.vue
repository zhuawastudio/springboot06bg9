	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="类型" prop="leixing">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="类型" prop="leixing">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../springboot06bg9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
